...
class IssuingProfileScreen extends StatelessWidget {
  const IssuingProfileScreen({super.key});
            ...
            child: Column(
              children: [
                CircleAvatar(
                  ...
                  child: const Icon(Icons.verified_user_rounded, size: 40),
                ),
            ...
            child: Column(
              children: [
                ...
                if (user?.departmentCode != null)
                  ListTile(leading: const Icon(Icons.apartment_outlined), title: const Text('Department'), subtitle: Text(user!.departmentCode!)),
              ],
            ),
          ),
