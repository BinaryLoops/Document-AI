      ...
      body: ListView(
        ...
        children: [
          Center(
            child: Column(
              children: [
                ...
                Text(user?.name ?? 'Citizen', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          ...
          Card(
            child: Column(
              children: [
                if (user?.aadhaarMasked != null)
                  ListTile(leading: const Icon(Icons.badge_outlined), title: const Text('Aadhaar'), subtitle: Text(user!.aadhaarMasked!)),
                if (user?.phone != null)
